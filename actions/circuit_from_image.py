...
def _to_spice(circuit: dict) -> str:
    ...
    lines.append(f"* Generated by O.R.I.O.N circuit_from_image at {datetime.now().isoformat(timespec='seconds')}")
    lines.append("")
    ...
    for comp in components:
        ...
        if ctype in ("resistor", "capacitor", "inductor"):
            ...
            if len(pins) < 5:
                ...
                continue
            lines.append(f"X{cid.lstrip('X')} {pins[0]} {pins[1]} {pins[2]} {pins[3]} {pins[4]} LM358")
