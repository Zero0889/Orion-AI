...
from orion.agent.error_handler import ErrorDecision, analyze_error, generate_fix
from orion.agent.planner import create_plan, replan
import contextlib
...
def _run_generated_code(
    ...
    if agent_id:
        try:
            from orion.agent.registry import ask_agent, has_agent
    ...
    try:
        ...
        env = os.environ.copy()
        try:
            from orion.core.cli_installer import extra_path_dirs
