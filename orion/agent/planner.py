...
def _build_agents_text() -> str:
    ...
    """
    try:
        from orion.agent.registry import list_agents
...
def _normalize_agent(step: dict) -> None:
    ...
    try:
        from orion.agent.registry import agent_can_use, agent_for_tool, has_agent, list_agents
    except Exception:
    ...
    try:
        ...
        for step in plan["steps"]:
            if step.get("tool") in ("generated_code",):
                ...
                from orion.agent.registry import agent_can_use, has_agent
