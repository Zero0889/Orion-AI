...
from orion.core.skills import get_skill, list_skills, max_inject_chars, reset_cache
import contextlib
...
async def install_skill(body: InstallBody) -> dict:
    ...
    scan_summary: dict = {}
    try:
        from orion.core.skill_scanner import scan_skill_dir
...
async def list_cli() -> list[dict]:
    ...
    from orion.core.cli_installer import registry_info
...
async def cli_status(name: str) -> dict:
    ...
    from orion.core.cli_installer import REGISTRY, cli_path
...
async def cli_install(name: str, force: bool = False) -> dict:
    ...
    from orion.core.cli_installer import REGISTRY, install_cli
