...
from orion.core.llm import get_provider
...
def agent_chat(agent_id: str, body: AgentChatBody) -> dict:
    ...
    from orion.agent.registry import ask_agent
...
def list_orchestra() -> list[dict]:
    ...
    """
    from orion.agent.orchestra_admin import load_config
...
def create_agent(body: AgentSpec, request: Request) -> dict:
    ...
    from orion.agent.orchestra_admin import get_agent_spec, upsert_agent
...
def remove_agent(agent_id: str, request: Request) -> dict:
    from orion.agent.orchestra_admin import delete_agent
